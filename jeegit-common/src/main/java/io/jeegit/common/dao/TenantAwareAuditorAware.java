...
/**
 * Bridges Spring Data JPA auditing to {@link TenantContext#actor()} so every {@code @CreatedBy} /
 * {@code @LastModifiedBy} field is populated with the current actor identifier without extra
 * wiring.
 */
@Component
