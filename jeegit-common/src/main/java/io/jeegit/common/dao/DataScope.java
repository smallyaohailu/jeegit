 ...
 *
 * <p>The scope is turned into a JPA {@code Specification} by a framework-provided factory so every
 * business query composes the same portable Criteria — no hand-written SQL fragments.
 */
