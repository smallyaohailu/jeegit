 ...
 *
 * <ul>
 *   <li>{@code parentId} — immediate parent (null for the root)
 *   <li>{@code parentIds} — comma-surrounded path from root to parent, e.g. {@code ",root,a,b,"} —
 *       enables descendant queries via {@code LIKE '%,x,%'}
 *   <li>{@code treeLevel} — depth, 0 for the root
 *   <li>{@code treeSort} — display sort within the same parent
 *   <li>{@code treeLeaf} — convenience flag for UI fold/unfold
 * </ul>
 *
