 ...
 *
 * <p>The {@code meta} map always contains the negotiated {@code locale} tag so
 * clients can observe which language the server rendered user-facing strings in.
 * Additional meta values can be provided by callers via
 * {@link #ok(Object, Map)}.</p>
 */
