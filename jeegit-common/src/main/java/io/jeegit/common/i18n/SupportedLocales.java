...
/**
 * The canonical list of locales jeegit ships first-party translations for. See {@code
 * docs/i18n/LANGUAGES.md} for the rationale behind the choice.
 */
public final class SupportedLocales {
  ...
  public static final List<Locale> ALL =
      List.of(EN, ZH_CN, ZH_TW, JA, KO, ES, FR, DE, PT_BR, RU, IT, AR);
  ...
  /**
   * Best-effort reduction of an arbitrary client locale to one of the supported locales. Rules: 1.
   * Exact language-tag match wins. 2. Same language + country synonyms: zh-HK/zh-MO -> zh-TW, zh-SG
   * -> zh-CN, pt-PT -> pt-BR. 3. Language-only match (ignoring country/variant) — picks the first
   * supported entry with the same ISO-639 language code. 4. Otherwise {@link #DEFAULT}.
   */
