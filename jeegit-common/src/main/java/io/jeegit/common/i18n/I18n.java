...
/**
 * Thin wrapper around {@link MessageSource} so application code does not have to
 * carry the locale parameter everywhere. Resolves the current locale from
 * {@link LocaleContextHolder}, which is populated by Spring's locale resolver
