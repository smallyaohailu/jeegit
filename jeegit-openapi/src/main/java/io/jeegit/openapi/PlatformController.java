...
/**
 * Open Platform entry controller. In the preview release it exposes
 * platform metadata and the supported-locale catalogue; it will grow into the
 * developer portal backend (API key management, resource catalogue, usage
 * metering) in subsequent releases.
 */
@RestController
...
public class PlatformController {
    ...
    public ApiResponse<List<Map<String, Object>>> locales() {
        List<Map<String, Object>> data = SupportedLocales.ALL.stream()
    ...
    private boolean isRightToLeft(Locale locale) {
        ...
        return "ar".equalsIgnoreCase(lang) || "he".equalsIgnoreCase(lang)
                || "fa".equalsIgnoreCase(lang) || "ur".equalsIgnoreCase(lang);
    }
}
