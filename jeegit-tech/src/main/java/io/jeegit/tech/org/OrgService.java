...
/**
 * Application service that keeps tree invariants ({@code parentIds}, {@code treeLevel}, {@code
 * treeLeaf} on the parent) consistent as nodes are created.
 */
@Service
public class OrgService {
  ...
  public List<Org> listDescendants(String nodeId) {
    return repository.findDescendants(
        TenantContext.tenant(), TreePaths.descendantLikePattern(nodeId));
  }
