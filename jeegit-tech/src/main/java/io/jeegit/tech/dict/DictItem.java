...
/**
 * Dictionary item — a single entry inside a {@link DictType}. The {@code attributes} column stores
 * JSON for structured extensions such as keyword arrays, priorities, or target-department codes in
 * routing rules.
 */
@Entity
@Table(
