...
/**
 * Dictionary type — a named catalogue (e.g. {@code MATTER_DISPATCH_RULE}, {@code DATA_SCOPE}). Used
 * as the single home for drop-down options, rule tables, and agent-visible configuration values.
 */
@Entity
@Table(
    name = "jg_dict_type",
