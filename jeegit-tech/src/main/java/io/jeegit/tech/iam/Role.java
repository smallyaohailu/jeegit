...
/**
 * Role entity — carries both <em>functional</em> permission grants (captured by role membership)
 * and a <em>data</em> scope declaration.
 *
 * <p>Unlike classic RBAC, the data-scope is declared here as a typed {@link DataScope} value; the
 * service layer turns it into a JPA {@code Specification}, so queries are portable Criteria rather
